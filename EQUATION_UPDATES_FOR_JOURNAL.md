...
These 68 principles had equations in the OFFICIAL sheet that were abstract, internally inconsistent, or produced uninterpretable numbers. We replaced them with clean, computable formulas (verified against a worked example, no em-dashes). Update the journal's source equations to match.
...
## 48. Counterparty Concentration Risk
- Old (sheet): CCR = Σ(Share_i ^ 2) — Herfindahl-style
- New:         CCR = Σ(Share_i ^ 2), Herfindahl-style
...
## 215. Minimum Effective Dose
- Old (sheet): Result/Effort — maximize
- New:         Result/Effort, maximize
